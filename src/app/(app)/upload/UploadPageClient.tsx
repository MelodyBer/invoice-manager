...
export default function UploadPageClient({ autoOpenCamera }: { autoOpenCamera: boolean }): React.JSX.Element {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Card className="flex flex-col gap-6">
        ...
        <DropZone onFilesSelected={handleFilesSelected} autoOpenCamera={autoOpenCamera} />
