...
export function MoneySummary({value,date,needsReview=false}:{value:FinancialColumns & {currency:string|null;amount_total:number|null};date?:string|null;needsReview?:boolean}):React.JSX.Element{
 ...
 {value.exchange_rate!==null&&value.exchange_rate_date?<p>שער בנק ישראל: {value.exchange_rate.toFixed(4)} ₪ לדולר, מיום {formatDateDDMMYYYY(value.exchange_rate_date)}</p>:<p>למסמך הישן עדיין לא נשמר שער. שמירה בעריכה תחשב אותו לפי תאריך המסמך.</p>}
 </div>;
}
