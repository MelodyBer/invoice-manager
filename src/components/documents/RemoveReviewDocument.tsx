...
export function RemoveReviewDocument({id, returnToList=false, label="הסר מהאישור"}: {id:string; returnToList?:boolean; label?:string}): React.JSX.Element {
