...
- אם במסמך מופיע רק הסכום הכולל בלי פירוט מע״מ, יש לחשב לאחור לפי שיעור מע״מ של 18%: amount_before_vat = amount_total חלקי 1.18, ו-vat_amount = amount_total פחות amount_before_vat.
